...
describe('Mobile layout of the site:', () => {
	it('should render Mobile menu with the opening hamburger button', () => {
		render(<Mobile click={false} closeMobileMenu={closeMobileMenu} handleMenu={handleMenu} />);
	...
	it('should render Mobile', () => {
		const { container } = render(
			<Mobile click={false} closeMobileMenu={closeMobileMenu} handleMenu={handleMenu} />
		);
